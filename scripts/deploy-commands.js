...
(async () => {
  ...
  console.log(`🚀 Deploying ${transformed.length} global commands...`);
  // If you want to deploy to guild (for testing): Routes.applicationGuildCommands(CLIENT_ID, GUILD_ID)
  // Here we deploy globally:
